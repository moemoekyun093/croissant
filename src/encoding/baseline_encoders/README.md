...
| `TurlTableEncoder` | visibility-matrix masked attention (row/column/global only) | header tokens are separate from cell tokens, globally visible in the attention mask — never concatenated into cell text | [sunlab-osu/TURL](https://github.com/sunlab-osu/TURL) |
